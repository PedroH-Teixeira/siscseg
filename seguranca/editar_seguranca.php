<div class="row">
    <div class="col-md-8 col-md-offset-2">
      ...
      <tbody>
      <form method="post">
          <tr><th><label for="id_seguranca">Código</label></th>
        <td><input type="text" name="id_seguranca" id="id_seguranca" size="4" maxlength="7" required/><input type="submit" value="Buscar Seguranca"></td>
          </tr>
          </tbody>
    </table>
  </div>
...
<?php
     if(isset($_POST["id_seguranca"])){
         $id_seguranca = $_POST["id_seguranca"]; 
         $sql = mysqli_query($mysqli,"SELECT * FROM cadastro_seguranca WHERE id = '$id_seguranca' LIMIT 1");
         while($exibe_id = $sql->fetch_array()){
?>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        <tr>
          ...
          <button onclick="form.action='index.php?pg=menu_admin&op=seguranca&acao=editar&foto=enviar'; form.submit()">Enviar</button></td>
          <?php }else{ ?> 
          <th>Foto:</th><td id="foto"><img src="imagens/foto/<?php echo $exibe_id["foto"]; ?>" id="previsualizar" class="previsualizar">
                ...
                <button onclick="form.action='index.php?pg=menu_admin&op=seguranca&acao=editar&foto=excluir'; form.submit()">Excluir</button></td>
          <?php } ?>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" onkeyup="maiuscula('endereco')" value="<?php echo $exibe_id["endereco"]; ?>" name="endereco" id="endereco" placeholder="Rua ou Avenida" size="20" maxlength="30"/> 
        ...
        <tr>
            <th> </th>
            <td><input type="text" onkeyup="maiuscula('endereco_bairro')" value="<?php echo $exibe_id["endereco_bairro"]; ?>" name="endereco_bairro" id="endereco_bairro" placeholder="Bairro" size="20" maxlength="30"/> 
            <input type="text" onkeyup="maiuscula('endereco_cidade')" value="<?php echo $exibe_id["endereco_cidade"]; ?>" name="endereco_cidade" id="endereco_cidade" placeholder="Cidade" size="15" maxlength="30"/>
...
<div class="col-md-4 col-md-offset-4 text-center">
        <input type="hidden" name="usuario" value="<?php  echo $exibe_id["id"]; ?>"/>
