...
<div class="row">    
  ...
  ?>
    ...
    <div class="col-md-8 col-md-offset-2">   
        ...
        <p>Eu, <b style="text-transform: uppercase"><?php echo $exibe["nome"];?></b>, portador do CPF nº <?php echo $exibe["cpf"];?>, recebi da empresa <b>DETROIT SEG VIGILANCIA E SEGURANÇA PRIVADA LTDA</b> o valor de R$ 6,80 (Seis reais e Oitenta centavos), referente ao pagamento do evento <b style="text-transform: uppercase"><?php echo $exibe["nome_evento"];?></b></p><br>
        <br>

        - Valor total pago: R$ 6,80<br>
